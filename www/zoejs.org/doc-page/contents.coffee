define ['cs!../page/line-break', 'less!./contents'], (LineBreak) ->
  ...
  ,
    render: """
      <a class='github' href='https://github.com/zestjs/zoe' target='_blank'>Github</a>
      <a class='built-zest' href='https://github.com/zestjs/zoejs.org' target='_blank'>Built with ZestJS</a>
    """
  ]
